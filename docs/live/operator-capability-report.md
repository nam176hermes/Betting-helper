...
Do not run the normal live capture flow to bootstrap a profile: it deliberately
requires an already accepted profile. A reviewed discovery flow must be bound
